<template>
  <el-row type="flex" justify="center" class="about">
      <el-col :xs="22" :sm="10">
          <h1>GrazJs #25</h1>

          <h2>"VueJS", by Marko Denić</h2>
          ...
          <a href="https://github.com/MarkoDenic/grazjs25">https://github.com/MarkoDenic/grazjs25</a>
